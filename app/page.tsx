    ...
    <div className="min-h-screen bg-background text-text">
      ...
      <section className="relative py-20 bg-gradient-to-br from-background via-background to-accent/10 dark:to-accent/5 overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h1 className="text-4xl md:text-6xl font-heading font-bold mb-6 text-text">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link
              href="/blog"
              className="px-8 py-3 bg-accent text-white rounded-lg hover:opacity-90 transition-opacity text-lg font-medium shadow-md hover:shadow-lg"
            >
              Explore Blog
            </Link>
            {!session && (
              <Link
                href="/signup"
                className="px-8 py-3 bg-white dark:bg-gray-700 text-gray-900 dark:text-white border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors text-lg font-medium shadow-sm"
              >
                Join Us
              </Link>
            )}
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            <div className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm p-4 rounded-lg border border-gray-200/70 dark:border-gray-600/50 shadow-sm hover:shadow-md transition-shadow">
