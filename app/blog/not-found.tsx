      ...
      <div className="relative z-10 max-w-2xl mx-auto">
        <div className="bg-background/80 backdrop-blur-xl border border-foreground/10 rounded-2xl p-8 md:p-12 shadow-2xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Link href="/blog" className="flex-1 px-6 py-3 bg-accent text-background rounded-xl hover:opacity-90 transition font-semibold text-center">Browse Articles</Link>
